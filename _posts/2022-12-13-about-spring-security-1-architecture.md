...
![filterchain](/images/2022-12-13-about-spring-security-1-architecture/filterchain.png){: width="560"}
...
![delegatingfilterproxy](/images/2022-12-13-about-spring-security-1-architecture/delegatingfilterproxy.png){: width="560"}
...
![filterchainproxy](/images/2022-12-13-about-spring-security-1-architecture/filterchainproxy.png){: width="560"}

스프링 시큐리티에서 서블릿에 대한 지원을 하는 특수 필터로 SecurityFilterChain을 통해 많은 Filter인스턴스에 위임 가능

### SecurityFilterChain

![securityfilterchain](/images/2022-12-13-about-spring-security-1-architecture/securityfilterchain.png){: width="560"}
...
![multi-securityfilterchain](/images/2022-12-13-about-spring-security-1-architecture/multi-securityfilterchain.png){: width="560"}
...
![exceptiontranslationfilter](/images/2022-12-13-about-spring-security-1-architecture/exceptiontranslationfilter.png){: width="560"}
