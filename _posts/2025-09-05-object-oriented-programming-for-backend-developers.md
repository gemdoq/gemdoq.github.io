...
categories: concepts
tags: [OOP, Object Oriented]
typora-root-url: ../

---
# ✈️ 백엔드 개발자에게 객체지향의 의미와 개념

## 🎯 개요

객체지향 프로그래밍(OOP)은 현실 세계의 사물이나 개념을 프로그램의 객체로 모델링하는 개발 방식
프로그램을 객체들의 모임으로 보고, 객체 간의 상호작용으로 시스템을 설계함
...
스프링부트 개발에서 Entity, Service, Repository는 모두 객체지향의 산물이며, 각각의 책임을 명확히 나누는 것이 좋은 객체지향 설계
